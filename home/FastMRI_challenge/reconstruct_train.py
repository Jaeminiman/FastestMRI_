...
def parse():
    ...
    parser.add_argument('-t', '--path_data', type=Path, default='/workspace/Fastest/Data/train', help='Directory of train data')
...
if __name__ == '__main__':
    ...
    args.forward_dir = '../result' / args.net_name / 'reconstructions_training'
