...
def save_reconstructions(reconstructions, out_dir, targets=None, inputs=None, grappas=None):
    """
    ...
    for fname, recons in reconstructions.items():
        ...
        with h5py.File(out_dir / fname, 'w') as f:
            ...
            if grappas is not None:
                f.create_dataset('grappa', data=grappas[fname])
